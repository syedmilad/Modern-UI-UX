  ...
  return (
    <section className='flex md:flex-row flex-col'>
      ...
      <div className='flex-1 flex justify-center items-start flex-col'>
          ...
          <p className='font-poppins font-normal text-dimWhite text-[18px] leading-[30.8px] min-w-[170px] mt-5 '>With the right credit card, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market.</p>
